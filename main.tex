...
\faculty{Dr.\,Dhanasekar, Dr.\,V.\,Parthiban, Dr.\,Manivannan, Dr.\,David Raj Micheal,} % write all the faculties in case of common qp. (Use \, for the space in the names to avoid hypernation.)
\classNumber{CH2021222300226, 227,228, 229} % write all the class numbers in case of common qp.
\slot{B2+TB2}
...
%%--For printing Labels
\slotFaculty{Dr. David Raj Micheal}
\slotClassNumber{CH2021222300226}
\slotFacultyempid{51942}
\slotFacultyMobile{+91 99999 00000}
\examdate{30/08/2022 }
\examtime{9.00 AM to 10.30 AM }
\classrooms{DB--108,DB--203 ,DB--204}
\students{9+2,36+2,25+2}
...
ERB\module{02}  \co{02} \level{Easy} \bl{K2} \hots{No}
...
\part
\begin{subparts}
\subpart[3] Subpart 01
\subpart[2] Subpart 02
\end{subparts}
\end{parts}
